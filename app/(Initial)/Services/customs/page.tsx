    ...
    <>
      ...
      <div className={`${styles.Paper} ${isRtl ? styles.rtl : styles.ltr}`}>
          ...
          <div className={styles.partie1}>
            <div className={styles.contenue}>
              <div className={styles.image_demande}>
                <Image className={styles.imagec} src="/img/Background/quote.svg" alt="msg" width={50} height={50} />
              </div>
        ...
        <div className={styles.Paper_d}>
          <h1 className={styles.sectionHeading2}>{t('Train.title')}</h1>

          <div className={styles.description}>{t('Train.description1')}</div>
          <div className={styles.description}>{t('Train.description2')}</div>
          <div className={styles.description}>{t('Train.description3')}</div>
          ...
          <div className={styles.Card}>
            <div className={styles.sous_Card1}>
              <div className={styles.texts_card}>
                ...
                <div className={styles.desc_card}>{t('Train.card1_description')}</div>
              </div>
            </div>
            ...
            <div className={styles.sous_Card1}>
              <div className={styles.texts_card}>
                ...
                <div className={styles.desc_card}>{t('Train.card2_description')}</div>
              </div>
            </div>
          </div>
