    ...
    <>
      ...
      <div className={`${styles.Paper} ${isRtl ? styles.rtl : styles.ltr}`}>
        <div className={styles.Paper_g}>
          ...
          <div className={styles.partie1}>
            <div className={styles.contenue}>
              ...
              <h2 className={styles.titre_demande}>{t("Plane.request_help_title")}</h2>

              <div className={styles.Description_demande}>
                {t("Plane.request_help_description")}
              </div>
        ...
        <div className={styles.Paper_d}>
          <h1 className={styles.sectionHeading2}>{t("Plane.title")}</h1>

          <div className={styles.description}>{t("Plane.description1")}</div>
          <div className={styles.description}>{t("Plane.description2")}</div>

          {/* ✅ Direction appliquée ici aussi comme dans ServiceDetail */}
