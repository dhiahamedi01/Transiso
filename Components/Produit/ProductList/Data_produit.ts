export type Product = {
  ...
  export const products: Product[] = [
    ...
    { id: 1, title: "حقيبة سبيدي باندوليير", price: 2300, image: "/img/Product/sacluis.png", rating: 4.4, category: "معدات صناعية", description: "المصنوعة من قماش مونوغرام الشهير" },
    { id: 2, title: "إطارات سيارات", price: 1600, image: "/img/Product/Car2.png", tag: "متوفر", rating: 4.3, category: "إطارات وقطع غيار سيارات", description: "إطارات متينة وعالية الأداء لجميع السيارات." },
    ...
    { id: 5, title: "مبردات هواء", price: 1200, image: "/img/Product/produit1.webp", rating: 4.1, category: "أجهزة التبريد والتكييف", description: "مبردات هواء فعالة للطاقة ومناسبة للمكاتب." },
    { id: 6, title: "ألواح خشبية", price: 1100, image: "/img/Product/silvio.webp", tag: "متوفر", rating: 4.2, category: "مواد البناء", description: "ألواح خشبية صلبة ومقاومة للرطوبة." },
