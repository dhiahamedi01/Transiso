    ...
    <div className={styles.banner2}>
      ...
      <div className={styles.partieTexte}>
        ...
        <ul className={styles.points}>
          <li><DoneIcon className={styles.icon} /> خبرة واسعة في الشحن الجوي والبحري</li>
          <li><DoneIcon className={styles.icon} /> شبكة فروع عالمية</li>
          <li><DoneIcon className={styles.icon} /> فريق عمل محترف</li>
          <li><DoneIcon className={styles.icon} /> الالتزام بالدقة والموثوقية</li>
        </ul>

        <div className={styles.decorIcone}>
          <Image 
            src="/img/element/s.png"
            alt="décor bas"
            width={80}
            height={80}
          />
