    ...
    <>
      ...
      <div className={styles.heroContainer}>
        ...
        <div className={styles.contentBox} dir="rtl">
          <h1 className={styles.title}>هل ترغب بإرسال شحنة جوية؟</h1>
          <p className={styles.description}>
            ...
            ندرك في ترانسيسو أهمية الوقت والدقة في الشحن الجوي، لذلك لا تترددوا بالتواصل معنا للاستفسار عن خدماتنا المتنوعة.
          </p>
      ...
      <div className={styles.heroContainer2}>
        <div className={styles.contentBox} dir="rtl">
          <h1 className={styles.title}>هل ترغب بارسال حاوية بحرية؟</h1>
          <p className={styles.description}>
